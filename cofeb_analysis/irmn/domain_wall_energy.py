...
# @Last modified time: 2017-02-08T16:32:03-08:00
...
demag_energy0, h0, d0 = decn.demag_energy_calc_newell(domains, MsSI, res, thicknessSI)
demag_energy0_norm = demag_energy0 / ( (res*(slen-2))**2 )
demag_energy1, h1, d1 = decn.demag_energy_calc_newell(domains, MsSI, res+res_difference, thicknessSI)
