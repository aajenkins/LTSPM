...
for i in range(0,hnum):
    ...
    simx = np.add(np.multiply(np.arange(0,sres*tlen,sres),1),-0.1)
    blochnv[i][0] = simx
...
ffxcut = [np.arange(0,(cutcrop[1]-cutcrop[0])*dsize/dres,dsize/dres),ffdata[0][cutcrop[0]:cutcrop[1],xline],ffdata[1][cutcrop[0]:cutcrop[1],xline]]
