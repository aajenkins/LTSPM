...
heights = [98,106,120]
#blochfms = glob.glob(basepath+'bloch*_400*.dat')
#nleftfms = glob.glob(basepath+'neelleft*_400*.dat')
#nrightfms = glob.glob(basepath+'neelright*_400*.dat')
#blochfms=['bloch_x_106_30._400_10..dat]
...
for i in range(0,1):
    ...
    simx = np.add(np.multiply(np.arange(0,sres*tlen,sres),0.8),0.34)
    blochnv[i][0] = simx
...
line = 29 
ffycut = [np.arange(0,dsize,dsize/dres),ffdata[0][line,:],ffdata[1][line,:]]
